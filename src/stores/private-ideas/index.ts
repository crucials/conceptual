...
export const privateIdeasSlice = createSlice({
    ...
    extraReducers: builder => {
        builder.addCase(privateIdeasLoadingThunk.pending, (state) => ({ ...state, status: 'loading' }))
...
export const selectPrivateIdeasStatus = (state: RootState) => state.privateIdeas.status
